...
class pixcnn_model :
    def __init__(self,json_dir,cuda=True,depth=6,depth2=4,ndf=32) :
        ...
        self.netFE = FeatureExtractor(in_ch=2,ndf=ndf,depth=depth)
        self.netPx = PixCNNPrior(feature_input_dim=ndf,out_ch=1,depth=depth2)
    ...
    def train(self) :
        ...
        for epoch in range(self.start_epochs,self.epochs) :
            ...
            if valloader is not None :
                ...
                self.val(valloader,self.val_path,4,epoch)
